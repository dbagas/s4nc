  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100"  data-aos="fade" src="<?php echo e(asset('templates')); ?>/img/S4nc.png" alt="First slide">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo e(asset('templates')); ?>/img/S4nc.png" alt="Second slide">
            <div class="carousel-caption d-none d-md-block ">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">S4NC</h1>
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo e(asset('templates')); ?>/img/S4nc.png" alt="Third slide">
            <div class="carousel-caption d-none d-md-block ">
              <div class="slide">
                <h1 class="text-uppercase" data-aos="fade-up">S4NC</h1>
