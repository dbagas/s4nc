            ...
            <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="" alt="">S4NC</a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item"><a class="nav-link" href="services.html">Discord</a>
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="portfolio.html">Meh96</a></li>
										<li class="nav-item"><a class="nav-link" href="portfolio-details.html">BlackPanda</a></li>
                                        <li class="nav-item"><a class="nav-link" href="elements.html">unex</a></li>
                                        <li class="nav-item"><a class="nav-link" href="elements.html">spilner</a></li>
                                        <li class="nav-item"><a class="nav-link" href="elements.html">Tommeister23</a></li>
									</ul>
								</li> 
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Division</a>
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="blog.html">PUBGM</a></li>
										<li class="nav-item"><a class="nav-link" href="single-blog.html">DOTA2</a></li>
									</ul>
								</li> 
        	...
        	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="<?php echo e(asset('templates')); ?>/img/post_2.png" alt="First slide">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo e(asset('templates')); ?>/img/post_2.png" alt="Second slide">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo e(asset('templates')); ?>/img/post_2.png" alt="Third slide">
                  </div>
                </div>
...
</html><?php /**PATH C:\belajar-laravel\resources\views/layout/template.blade.php ENDPATH**/ ?>