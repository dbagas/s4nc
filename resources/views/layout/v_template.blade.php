...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{asset('templates')}}/img/favicon.png" type="image/png">
        ...
        <link rel="stylesheet" href="{{asset('templates')}}/vendors/lightbox/simpleLightbox.css">
        <link rel="stylesheet" href="{{asset('templates')}}/vendors/nice-select/css/nice-select.css">
        <link rel="stylesheet" href="{{asset('templates')}}/vendors/animate-css/animate.css">
        <link rel="stylesheet" href="{{asset('templates')}}/vendors/flaticon/flaticon.css">
        <!-- main css -->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Team S4NC
        ...
        <script src="{{asset('templates')}}/vendors/nice-select/js/jquery.nice-select.min.js"></script>
        <script src="{{asset('templates')}}/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="{{asset('templates')}}/vendors/isotope/isotope-min.js"></script>
        ...
        <script src="{{asset('templates')}}/vendors/counter-up/jquery.waypoints.min.js"></script>
        <script src="{{asset('templates')}}/vendors/counter-up/jquery.counterup.min.js"></script>
        <script src="{{asset('templates')}}/js/mail-script.js"></script>
        <!--gmaps Js-->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
        <script src="{{asset('templates')}}/js/gmaps.min.js"></script>
        <script src="{{asset('templates')}}/js/theme.js"></script>
    </body>
</html>